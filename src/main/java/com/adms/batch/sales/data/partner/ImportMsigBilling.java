...
public class ImportMsigBilling extends AbstractImportSalesJob {
...
//			}
	...
	public static void main(String[] args)
			throws Exception
	{
		String fileFormatFileName = "fileformat/salesdb/FileFormat_MSIG_Billing_Result.xml";
		...
		ImportMsigBilling batch = new ImportMsigBilling();
