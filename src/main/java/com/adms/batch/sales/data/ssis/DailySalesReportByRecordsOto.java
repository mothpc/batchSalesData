...
//		test("D:/Work/Report/DailyReport/201412");
		new DailySalesReportByRecordsOto().test("D:/Work/Report/DailyReport/201501");
//		new DailySalesReportByRecordsOto().test(args[0]);
			...
			throws Exception
	{
		...
		fw.walk(sInputPath, new FilenameFilter()
		{
			...
			{
				return !name.contains("~$") && (dir.getAbsolutePath().contains("OTO") && (name.contains("SalesReportByRecords_") || name.contains("SalesReportByRecords.xlsx")));
			}
		});
